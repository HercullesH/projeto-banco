    ...
    <div class="margem-navbar">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="date" class="form-control" id="dataInicial" placeholder="name@example.com" value="2018-01-01" style="background:#FAFAFA;">
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="date" class="form-control" id="dataFinal" placeholder="name@example.com" value="2018-12-31" style="background:#FAFAFA;">
          </div>
        </div>
